// src/_root/pages/Followers.tsx
import { Loader, UserCard } from "@/components/shared";
import { useUserContext } from "@/context/AuthContext";
import { useUser, useFollowersList } from "@/lib/react-query/queries";
...
const Followers = () => {
  ...
  const { data: followers, isLoading: isFollowersLoading } = useFollowersList(id);
